...
class GlobalColors{
  ...
  static const fireColor = const Color(0xFFF3403F);
  static const lightFireColor = const Color(0xFFFF8EB4);
  static const pinkColor = const Color(0xffff3847);
  static const lightPinkColor = const Color(0xFFFFAEB4);

  static const goldColor = const Color(0xffffd230);
  static const lightGoldColor = const Color(0xffffe27a);
...
class GlobalVariables{
  ...
  static const PLACEHOLDER_IMAGE = "https://wolper.com.au/wp-content/uploads/2017/10/image-placeholder.jpg";
  ...
  static const Map<String, Badge> allBadges = {
    ...
    "justStarted" : Badge(description: "Just started",icon: FontAwesomeIcons.airFreshener, colors:[GlobalColors.goldColor,GlobalColors.lightGoldColor]),
    "watching" : Badge(description: "Watching",icon: FontAwesomeIcons.hourglassHalf, colors:[GlobalColors.greyTextColor, Colors.white54]),
    "finished" : Badge(description: "Finished",icon: FontAwesomeIcons.checkDouble, colors:[GlobalColors.greenColor, Colors.greenAccent]),
    "hasMoreEpisodes" : Badge(description: "Running",icon: FontAwesomeIcons.pizzaSlice, colors:[Colors.orangeAccent, Colors.orange]),
    "waiting" : Badge(description: "Waiting for new episodes",icon: FontAwesomeIcons.stopwatch20, colors:[Colors.lightBlue, GlobalColors.blueColor]),
    "favorite" : Badge(description: "Favorite",icon: FontAwesomeIcons.solidHeart, colors:[GlobalColors.pinkColor,GlobalColors.lightPinkColor]),
  };
