    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `UserData` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `uid` TEXT NOT NULL, `email` TEXT NOT NULL, `password` TEXT NOT NULL, `biometrics` INTEGER NOT NULL)');
      ...
      : _queryAdapter = QueryAdapter(database, changeListener),
        _userDataInsertionAdapter = InsertionAdapter(
            ...
            (UserData item) => <String, Object?>{
                  ...
                  'biometrics': item.biometrics ? 1 : 0
                },
            changeListener),
